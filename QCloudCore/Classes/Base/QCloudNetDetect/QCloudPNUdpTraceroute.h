...
typedef void (^QCloudPNUdpTracerouteHandler)(NSMutableString *);


@interface QCloudPNUdpTraceroute : NSObject
...
/**
 ...
 @return a `QCloudPNUdpTraceroute` instance.
 */
