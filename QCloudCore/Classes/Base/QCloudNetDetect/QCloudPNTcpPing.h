...
@interface QCloudPNTcpPingResult : NSObject
...
typedef void (^QCloudPNTcpPingHandler)(NSMutableString *);

@interface QCloudPNTcpPing : NSObject
...
/**
 ...
 @return `QCloudPNTcpPing` instance
 */
