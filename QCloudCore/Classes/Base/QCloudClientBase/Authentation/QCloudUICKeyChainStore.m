...
- (CFTypeRef)itemClassObject
{
    switch (_itemClass) {
        ...
        case QCloudUICKeyChainStoreItemClassInternetPassword:
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        ...
        case QCloudUICKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case QCloudUICKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case QCloudUICKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case QCloudUICKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case QCloudUICKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case QCloudUICKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case QCloudUICKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case QCloudUICKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case QCloudUICKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case QCloudUICKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case QCloudUICKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case QCloudUICKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case QCloudUICKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case QCloudUICKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case QCloudUICKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case QCloudUICKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case QCloudUICKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case QCloudUICKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case QCloudUICKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case QCloudUICKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case QCloudUICKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case QCloudUICKeyChainStoreProtocolTypeDAAP:
            return kSecAttrProtocolDAAP;
        case QCloudUICKeyChainStoreProtocolTypeEPPC:
            return kSecAttrProtocolEPPC;
        case QCloudUICKeyChainStoreProtocolTypeNNTPS:
            return kSecAttrProtocolNNTPS;
        case QCloudUICKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case QCloudUICKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case QCloudUICKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case QCloudUICKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        ...
        case QCloudUICKeyChainStoreAuthenticationTypeMSN:
            return kSecAttrAuthenticationTypeMSN;
        case QCloudUICKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case QCloudUICKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case QCloudUICKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case QCloudUICKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case QCloudUICKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case QCloudUICKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        ...
        case QCloudUICKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case QCloudUICKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case QCloudUICKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case QCloudUICKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case QCloudUICKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case QCloudUICKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
