    ...
    if (self = [super init]) {
        ...
        if (!_installationId) {
            ...
            dispatch_once(&onceToken, ^{
                [keychain setString:[[NSUUID UUID] UUIDString] forKey:QCloudClientContextKeychainInstallationIdKey];
            });
            _installationId = [keychain stringForKey:QCloudClientContextKeychainInstallationIdKey];
        }
...
- (NSDictionary *)dictionaryRepresentation {
    NSDictionary *clientDetails = @{
        @"installation_id" : self.installationId ? self.installationId : @"UNKNOWN_INSTALLATION_ID",
    ...
    NSDictionary *clientContext = @{
        @"version" : QCloudClientContextVersion,
