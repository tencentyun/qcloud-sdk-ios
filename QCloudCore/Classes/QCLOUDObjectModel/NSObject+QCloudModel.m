...
static force_inline QCloudEncodingNSType QCloudClassGetNSType(Class cls) {
    if (!cls) return QCloudEncodingTypeNSUnknown;
    if ([cls isSubclassOfClass:[NSMutableString class]]) return QCloudEncodingTypeNSMutableString;
    if ([cls isSubclassOfClass:[NSString class]]) return QCloudEncodingTypeNSString;
    if ([cls isSubclassOfClass:[NSDecimalNumber class]]) return QCloudEncodingTypeNSDecimalNumber;
    ...
    if ([cls isSubclassOfClass:[NSMutableData class]]) return QCloudEncodingTypeNSMutableData;
    if ([cls isSubclassOfClass:[NSData class]]) return QCloudEncodingTypeNSData;
    if ([cls isSubclassOfClass:[NSDate class]]) return QCloudEncodingTypeNSDate;
    if ([cls isSubclassOfClass:[NSURL class]]) return QCloudEncodingTypeNSURL;
    if ([cls isSubclassOfClass:[NSMutableArray class]]) return QCloudEncodingTypeNSMutableArray;
    if ([cls isSubclassOfClass:[NSArray class]]) return QCloudEncodingTypeNSArray;
    if ([cls isSubclassOfClass:[NSMutableDictionary class]]) return QCloudEncodingTypeNSMutableDictionary;
    if ([cls isSubclassOfClass:[NSDictionary class]]) return QCloudEncodingTypeNSDictionary;
    if ([cls isSubclassOfClass:[NSMutableSet class]]) return QCloudEncodingTypeNSMutableSet;
...
static force_inline BOOL QCloudEncodingTypeIsCNumber(QCloudEncodingType type) {
    switch (type & QCloudEncodingTypeMask) {
        ...
        case QCloudEncodingTypeLongDouble: return YES;
        default: return NO;
    }
}
...
static id ModelToJSONObjectRecursive(NSObject *model) {
    ...
    if ([model isKindOfClass:[NSDate class]]) return [QCloudISODateFormatter() stringFromDate:(id)model];
...
static NSString *ModelDescription(NSObject *model) {
    ...
    switch (modelMeta->_nsType) {
        case QCloudEncodingTypeNSString: case QCloudEncodingTypeNSMutableString: {
            return [NSString stringWithFormat:@"\"%@\"",model];
        }
        
        case QCloudEncodingTypeNSValue:
        case QCloudEncodingTypeNSData: case QCloudEncodingTypeNSMutableData: {
        ...
        case QCloudEncodingTypeNSSet: case QCloudEncodingTypeNSMutableSet: {
            model = ((NSSet *)model).allObjects;
        } // no break
            
        case QCloudEncodingTypeNSArray: case QCloudEncodingTypeNSMutableArray: {
        ...
        case QCloudEncodingTypeNSDictionary: case QCloudEncodingTypeNSMutableDictionary: {
            ...
            for (NSUInteger i = 0, max = properties.count; i < max; i++) {
                ...
                if (property->_isCNumber) {
                    ...
                    switch (property->_type & QCloudEncodingTypeMask) {
                        ...
                        case QCloudEncodingTypeCArray: case QCloudEncodingTypeCString: case QCloudEncodingTypePointer: {
                            void *pointer = ((void* (*)(id, SEL))(void *) objc_msgSend)((id)model, property->_getter);
                            propertyDesc = [NSString stringWithFormat:@"%p",pointer];
                        } break;
                        case QCloudEncodingTypeStruct: case QCloudEncodingTypeUnion: {
...
+ (instancetype)qcloud_modelWithDictionary:(NSDictionary *)dictionary {
    ...
    if ([one qcloud_modelSetWithDictionary:dictionary]) return one;
    return nil;
}
