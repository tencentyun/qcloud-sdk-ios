...
/**
 ...
 具体请查看  https://cloud.tencent.com/document/product/460/106020.
...
@interface QCloudCreateDatasetRequest : QCloudBizHTTPRequest

/// 请求输入参数
@property (nonatomic,strong)QCloudCreateDataset * input;
