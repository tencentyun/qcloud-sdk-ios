...
@implementation QCloudPutBucketWebsiteRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    if (!self.websiteConfiguration) {
        if (error != NULL) {
            *error = [NSError qcloud_errorWithCode:QCloudNetworkErrorCodeParamterInvalid message:[NSString stringWithFormat:@"paramter[websiteConfiguration] is invalid (nil), it must have some value. please check it"]];
            return NO;
        }
    }
    [self.requestData setParameter:[self.websiteConfiguration qcloud_modelToJSONObject] withKey:@"WebsiteConfiguration"];
