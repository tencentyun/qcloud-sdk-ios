//
//  ListBucketInventoryConfigurations.m
...
@implementation QCloudListBucketInventoryConfigurationsRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudListInventoryConfigurationResult class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    if (self.continuationToken) {
        [self.requestData setValue:self.continuationToken forHTTPHeaderField:@"continuation-token"];
    }
