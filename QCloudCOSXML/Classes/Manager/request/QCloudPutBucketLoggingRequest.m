...
@implementation QCloudPutBucketLoggingRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [self.requestData setParameter:[self.bucketLoggingStatus qcloud_modelToJSONObject] withKey:@"BucketLoggingStatus"];
