//
//  QCloudGetBucketPolicyRequest.m
//  QCloudGetBucketPolicyRequest
//
//  Created by tencent
...
@implementation QCloudGetBucketPolicyRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock(QCloudBucketPolicyResult.class)
...
- (void)setFinishBlock:(void (^_Nullable)(QCloudBucketPolicyResult * _Nullable outputObject, NSError * _Nullable error))QCloudRequestFinishBlock{
