...
@implementation QCloudGetBucketReplicationRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray* responseSerializers = @[
                                    ...
                                    QCloudResponseObjectSerilizerBlock([QCloudBucketReplicationConfiguation class])
                                    ];
...
-(NSArray<NSMutableDictionary *> *)scopesArray{
    ...
    dic[@"prefix"] = @"";
    dic[@"action"] = @"name/cos:GetBucketReplication";
