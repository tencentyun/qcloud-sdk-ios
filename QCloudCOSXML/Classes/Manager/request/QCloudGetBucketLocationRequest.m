...
@implementation QCloudGetBucketLocationRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray* responseSerializers = @[
                                    ...
                                    QCloudResponseObjectSerilizerBlock([QCloudBucketLocationConstraint class])
                                    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    self.requestData.URIMethod = @"location";
    return YES;
}
...
-(NSArray<NSMutableDictionary *> *)scopesArray{
    ...
    dic[@"prefix"] = @"";
    dic[@"action"] = @"name/cos:GetBucketLocation";
