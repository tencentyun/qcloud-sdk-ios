...
@implementation QCloudPutBucketTaggingRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
        ...
        if (error != NULL) {
            *error = [NSError
                qcloud_errorWithCode:QCloudNetworkErrorCodeParamterInvalid
                             message:[NSString stringWithFormat:@"paramter[taggings] is invalid (nil), it must have some value. please check it"]];
            return NO;
        }
    }
