...
@implementation QCloudPutBucketReplicationRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setParameter:[self.configuation qcloud_modelToJSONObject] withKey:@"ReplicationConfiguration"];
...
-(NSArray<NSMutableDictionary *> *)scopesArray{
    ...
    dic[@"prefix"] = @"";
    dic[@"action"] = @"name/cos:PutBucketReplication";
