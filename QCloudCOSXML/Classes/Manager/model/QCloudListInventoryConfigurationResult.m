//
//  QCloudListInventoryConfigurationResult.m
...
@implementation QCloudListInventoryConfigurationResult

+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{
        @"inventoryConfiguration" : [QCloudInventoryConfiguration class],
    };
}
