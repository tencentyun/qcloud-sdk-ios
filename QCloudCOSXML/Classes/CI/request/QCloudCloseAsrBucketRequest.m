//
//  QCloudCloseAsrBucketRequest.m
//  QCloudCloseAsrBucketRequest
//
//  Created by tencent
...
@implementation QCloudCloseAsrBucketRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudCloseAsrBucketResponse class])
    ];
...
- (void)setFinishBlock:(void (^_Nullable)( QCloudCloseAsrBucketResponse * _Nullable result, NSError *_Nullable error))finishBlock{
