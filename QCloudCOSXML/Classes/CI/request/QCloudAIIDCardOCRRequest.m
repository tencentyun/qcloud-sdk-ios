...
@implementation QCloudAIIDCardOCRRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudAIIDCardOCRResponse class])
    ];
...
self.requestData.serverURL = __serverURL.absoluteString;
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"IDCardOCR" withKey:@"ci-process"];
    
    if (self.CardSide) {
        [self.requestData setQueryStringParamter:self.CardSide withKey:@"CardSide"];
    }
    if (self.Config) {
        [self.requestData setQueryStringParamter:self.Config withKey:@"Config"];
    }
    return YES;
}
