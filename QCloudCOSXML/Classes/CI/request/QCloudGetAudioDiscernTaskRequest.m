//
//  QCloudGetAudioDiscernTaskRequest.m
//  QCloudGetAudioDiscernTaskRequest
//
//  Created by tencent
...
@implementation QCloudGetAudioDiscernTaskRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudGetAudioDiscernTaskResult class])
    ];
...
- (void)setFinishBlock:(void (^_Nullable)(QCloudGetAudioDiscernTaskResult *_Nullable result, NSError *_Nullable error))finishBlock {
