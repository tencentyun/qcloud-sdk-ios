//
//  QCloudOpenAsrBucketRequest.m
//  QCloudOpenAsrBucketRequest
//
//  Created by tencent
...
@implementation QCloudOpenAsrBucketRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudOpenAsrBucketResponse class])
    ];
...
- (void)setFinishBlock:(void (^_Nullable)( QCloudOpenAsrBucketResponse * _Nullable result, NSError *_Nullable error))finishBlock{
