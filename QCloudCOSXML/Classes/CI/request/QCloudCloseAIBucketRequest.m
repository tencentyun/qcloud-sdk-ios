//
//  QCloudCloseAIBucketRequest.m
//  QCloudCloseAIBucketRequest
//
//  Created by tencent
...
@implementation QCloudCloseAIBucketRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudCloseAIBucketResponse class])
    ];
...
- (void)setFinishBlock:(void (^_Nullable)( QCloudCloseAIBucketResponse * _Nullable result, NSError *_Nullable error))finishBlock{
