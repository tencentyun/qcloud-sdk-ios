...
@implementation QCloudPostTranscodeRequest
...
,        QCloudURLFuseContentMD5Base64StyleHeaders
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudPostTranscode class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [params setObject:@"Transcode" forKey:@"Tag"];
