//
//  QCloudImageSearchBucketRequest.m
//  QCloudImageSearchBucketRequest
//
//  Created by tencent
...
@implementation QCloudImageSearchBucketRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [__pathComponents addObject:@"ImageSearchBucket"];
    self.requestData.URIComponents = __pathComponents;

    if(self.input.MaxQps == 0){
        self.input.MaxQps = 10;
    }
    if (self.input) {
