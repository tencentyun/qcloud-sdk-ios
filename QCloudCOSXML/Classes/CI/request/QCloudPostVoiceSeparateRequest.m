//
// QCloudPostVoiceSeparateRequest.m
//
//  Created by tencent
...
@implementation QCloudPostVoiceSeparateRequest
...
,        QCloudURLFuseContentMD5Base64StyleHeaders
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudVoiceSeparateResult class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [params setObject:@"VoiceSeparate" forKey:@"Tag"];
