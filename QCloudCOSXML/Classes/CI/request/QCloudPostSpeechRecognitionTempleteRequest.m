//
//  QCloudPostSpeechRecognitionTempleteRequest.m
...
@implementation QCloudPostSpeechRecognitionTempleteRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudPostSpeechRecognitionTempleteResponse class])
    ];
