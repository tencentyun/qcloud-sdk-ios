...
@implementation QCloudCreateQRcodeRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudCreateQRcodeResponse class])
    ];
...
self.requestData.serverURL = __serverURL.absoluteString;
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"qrcode-generate" withKey:@"ci-process"];
    if (self.qrcodeContent) {
        [self.requestData setQueryStringParamter:self.qrcodeContent withKey:@"qrcode-content"];
    }
        [self.requestData setQueryStringParamter:@(self.mode).stringValue withKey:@"mode"];
    if (self.width) {
        [self.requestData setQueryStringParamter:self.width withKey:@"width"];
    }
    return YES;
}
