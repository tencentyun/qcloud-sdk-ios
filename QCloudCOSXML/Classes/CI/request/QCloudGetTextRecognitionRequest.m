//
//  QCloudGetTextRecognitionRequest.m
...
@implementation QCloudGetTextRecognitionRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudTextRecognitionResult class])
    ];
...
- (void)setFinishBlock:(void (^_Nullable)(QCloudTextRecognitionResult *_Nullable result, NSError *_Nullable error))finishBlock {
