//
//  QCloudGetMediainfoRequest.m
//  QCloudGetMediainfoRequest
//
//  Created by tencent
...
@implementation QCloudGetMediaInfoRequest
- (void)dealloc {
}
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudMediaInfo class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [self.requestData setQueryStringParamter:@"videoinfo" withKey:@"ci-process"];
...
- (void)setFinishBlock:(void (^_Nullable)(QCloudMediaInfo *_Nullable result, NSError *_Nullable error))finishBlock {
