...
@implementation QCloudGetSearchImageRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudGetSearchImageResponse class])
    ];
...
self.requestData.serverURL = __serverURL.absoluteString;
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"ImageSearch" withKey:@"ci-process"];
    
    if (self.action) {
        [self.requestData setQueryStringParamter:self.action withKey:@"action"];
    }
    
    [self.requestData setQueryStringParamter:@(self.MatchThreshold).stringValue withKey:@"MatchThreshold"];
    [self.requestData setQueryStringParamter:@(self.Offset).stringValue withKey:@"Offset"];
    [self.requestData setQueryStringParamter:@(self.Limit).stringValue withKey:@"Limit"];
    if (self.Filter) {
        [self.requestData setQueryStringParamter:self.Filter withKey:@"Filter"];
    }
    return YES;
}
