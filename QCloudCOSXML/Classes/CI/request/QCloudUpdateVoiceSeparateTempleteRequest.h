//
//  QCloudUpdateVoiceSeparateTempleteRequest.h
...
/**
 ...
 具体请查看  https://cloud.tencent.com/document/product/460/84757.
...
@interface QCloudUpdateVoiceSeparateTempleteRequest : QCloudBizHTTPRequest
...
/// 请求输入参数
@property (nonatomic,strong)QCloudUpdateVoiceSeparateTemplete * input;

- (void)setFinishBlock:(void (^_Nullable)( QCloudUpdateVoiceSeparateTempleteResponse * _Nullable result, NSError *_Nullable error))finishBlock;
