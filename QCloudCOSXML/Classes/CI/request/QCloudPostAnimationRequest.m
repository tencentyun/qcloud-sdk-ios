...
@implementation QCloudPostAnimationRequest
...
,        QCloudURLFuseContentMD5Base64StyleHeaders
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudPostAnimation class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [params setObject:@"Animation" forKey:@"Tag"];
