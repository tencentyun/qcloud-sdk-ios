...
@implementation QCloudExtractNumMarkRequest
...
,        QCloudURLFuseContentMD5Base64StyleHeaders
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudExtractNumMark class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [params setObject:@"ExtractDigitalWatermark" forKey:@"Tag"];
