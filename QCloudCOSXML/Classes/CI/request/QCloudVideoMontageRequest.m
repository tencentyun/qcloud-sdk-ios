...
@implementation QCloudVideoMontageRequest
...
,        QCloudURLFuseContentMD5Base64StyleHeaders
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudVideoMontage class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [params setObject:@"VideoMontage" forKey:@"Tag"];
