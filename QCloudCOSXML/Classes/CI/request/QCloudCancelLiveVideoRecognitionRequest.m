//
//  QCloudCancelLiveVideoRecognitionRequest.m
...
@implementation QCloudCancelLiveVideoRecognitionRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    if (!self.jobId || ([self.jobId isKindOfClass:NSString.class] && ((NSString *)self.jobId).length == 0)) {
        if (error != NULL) {
            *error = [NSError
    ...
    [__pathComponents addObject:@"video/cancel_auditing"];
