//
//  QCloudCreateMediaJobRequest.m
//  QCloudCreateMediaJobRequest
//
//  Created by tencent
...
@implementation QCloudCreateMediaJobRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudCreateMediaJobResponse class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    if(self.input){
        [self.requestData setParameter:self.input withKey:@"Request"];
    }
    
    return YES;
}
- (void)setFinishBlock:(void (^_Nullable)( QCloudCreateMediaJobResponse * _Nullable result, NSError *_Nullable error))finishBlock{
