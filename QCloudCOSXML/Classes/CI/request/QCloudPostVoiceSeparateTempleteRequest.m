//
//  QCloudPostVoiceSeparateTempleteRequest.m
...
@implementation QCloudPostVoiceSeparateTempleteRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudPostVoiceSeparateTempleteResponse class])
    ];
