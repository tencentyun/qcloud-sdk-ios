...
@implementation QCloudCIFaceEffectRequest
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudEffectFaceResult class])
    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setQueryStringParamter:@"face-effect" withKey:@"ci-process"];
    
    if(self.type != 0){
        [self.requestData setQueryStringParamter:QCloudFaceEffectEnumTransferToString(self.type) withKey:@"type"];
    }
    [self.requestData setQueryStringParamter:@(self.whitening).stringValue withKey:@"whitening"];
    [self.requestData setQueryStringParamter:@(self.smoothing).stringValue withKey:@"smoothing"];
    [self.requestData setQueryStringParamter:@(self.faceLifting).stringValue withKey:@"faceLifting"];
    [self.requestData setQueryStringParamter:@(self.eyeEnlarging).stringValue withKey:@"eyeEnlarging"];
    
    [self.requestData setQueryStringParamter:@(self.gender).stringValue withKey:@"gender"];
    [self.requestData setQueryStringParamter:@(self.age).stringValue withKey:@"age"];
