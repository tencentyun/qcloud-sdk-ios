//
//  QCloudCIAutoTranslationRequest.m
...
@implementation QCloudCIAutoTranslationRequest
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudAutoTranslationResult class])
    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setQueryStringParamter:@"AutoTranslationBlock" withKey:@"ci-process"];
    if(self.InputText){
        [self.requestData setQueryStringParamter:self.InputText withKey:@"InputText"];
    }

    if(self.SourceLang){
        [self.requestData setQueryStringParamter:self.SourceLang withKey:@"SourceLang"];
    }
    
    if(self.TargetLang){
        [self.requestData setQueryStringParamter:self.TargetLang withKey:@"TargetLang"];
    }
    
    if(self.TextDomain){
        [self.requestData setQueryStringParamter:self.TextDomain withKey:@"TextDomain"];
    }
    
    if(self.TextStyle){
        [self.requestData setQueryStringParamter:self.TextStyle withKey:@"TextStyle"];
    }
