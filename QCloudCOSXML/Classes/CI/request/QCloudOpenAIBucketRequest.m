//
//  QCloudOpenAIBucketRequest.m
//  QCloudOpenAIBucketRequest
//
//  Created by tencent
...
@implementation QCloudOpenAIBucketRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudOpenAIBucketResult class])
    ];
...
- (void)setFinishBlock:(void (^_Nullable)(QCloudOpenAIBucketResult * _Nullable result, NSError *_Nullable error))finishBlock {
