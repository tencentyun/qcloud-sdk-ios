//
//  QCloudDescribeHashProcessJobsRequest.m
//  QCloudDescribeHashProcessJobsRequest
//
//  Created by tencent
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudDescribeHashProcessJobsResponse class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [__pathComponents addObject:@"file_jobs"];
    if(self.jobId){
...
- (void)setFinishBlock:(void (^_Nullable)( QCloudDescribeHashProcessJobsResponse * _Nullable result, NSError *_Nullable error))finishBlock{
