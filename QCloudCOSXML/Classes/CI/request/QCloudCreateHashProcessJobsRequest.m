//
//  QCloudCreateHashProcessJobsRequest.m
...
@implementation QCloudCreateHashProcessJobsRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"filehash" withKey:@"ci-process"];
    
    if (self.type) {
        [self.requestData setQueryStringParamter:self.type withKey:@"type"];
    }
    if (self.addtoheader) {
        [self.requestData setQueryStringParamter:self.addtoheader withKey:@"addtoheader"];
    }
    return YES;
}
