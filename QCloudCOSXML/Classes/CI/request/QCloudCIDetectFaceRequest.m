...
@implementation QCloudCIDetectFaceRequest
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudDetectFaceResult class])
    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setQueryStringParamter:@"DetectFace" withKey:@"ci-process"];
    [self.requestData setQueryStringParamter:@(self.maxFaceNum).stringValue withKey:@"max-face-num"];
