//
//  QCloudCIRecognizeLogoRequest.m
...
@implementation QCloudCIRecognizeLogoRequest
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudCILogoRecognitionResult class])
    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setQueryStringParamter:@"RecognizeLogo" withKey:@"ci-process"];
