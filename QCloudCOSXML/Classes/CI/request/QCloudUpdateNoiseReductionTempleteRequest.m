//
//  QCloudUpdateNoiseReductionTempleteRequest.m
...
@implementation QCloudUpdateNoiseReductionTempleteRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudUpdateNoiseReductionTempleteResponse class])
    ];
