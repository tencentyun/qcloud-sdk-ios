//
//  QCloudPostImageAuditReportRequest.m
...
@implementation QCloudPostImageAuditReportRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudPostImageAuditReportResult class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [__pathComponents addObject:@"report"];
...
- (void)setFinishBlock:(void (^_Nullable)( QCloudPostImageAuditReportResult * _Nullable result, NSError *_Nullable error))finishBlock{
