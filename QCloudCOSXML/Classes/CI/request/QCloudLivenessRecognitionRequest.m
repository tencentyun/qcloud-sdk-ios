//
//  QCloudLivenessRecognitionRequest.m
...
@implementation QCloudLivenessRecognitionRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudLivenessRecognitionResponse class])
    ];
...
self.requestData.serverURL = __serverURL.absoluteString;
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"LivenessRecognition" withKey:@"ci-process"];
    if (self.IdCard) {
        [self.requestData setQueryStringParamter:self.IdCard withKey:@"IdCard"];
    }
    if (self.Name) {
        [self.requestData setQueryStringParamter:self.Name withKey:@"Name"];
    }
    if (self.LivenessType) {
        [self.requestData setQueryStringParamter:self.LivenessType withKey:@"LivenessType"];
    }
    if (self.ValidateData) {
        [self.requestData setQueryStringParamter:self.ValidateData withKey:@"ValidateData"];
    }
        [self.requestData setQueryStringParamter:@(self.BestFrameNum).stringValue withKey:@"BestFrameNum"];
    return YES;
}
