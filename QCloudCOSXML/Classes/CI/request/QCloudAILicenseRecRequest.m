...
@implementation QCloudAILicenseRecRequest
...
//        QCloudResponseObjectSerilizerBlock([QCloudAILicenseRecResponse class])
    ];
...
self.requestData.serverURL = __serverURL.absoluteString;
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"AILicenseRec" withKey:@"ci-process"];
    
    if (self.detectUrl) {
        [self.requestData setQueryStringParamter:self.detectUrl withKey:@"detect-url"];
    }
    if (self.CardType) {
        [self.requestData setQueryStringParamter:self.CardType withKey:@"CardType"];
    }
    return YES;
}
