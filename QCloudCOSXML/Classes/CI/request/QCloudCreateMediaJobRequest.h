...
@interface QCloudCreateMediaJobRequest : QCloudBizHTTPRequest

/// 存储桶名称
@property (nonatomic,strong)NSString * bucket;

/// 请求输入参数 具体请求查看 https://cloud.tencent.com/document/product/460/84764
