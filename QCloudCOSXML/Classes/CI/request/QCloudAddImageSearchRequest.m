...
@implementation QCloudAddImageSearchRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"AddImage" withKey:@"ci-process"];
