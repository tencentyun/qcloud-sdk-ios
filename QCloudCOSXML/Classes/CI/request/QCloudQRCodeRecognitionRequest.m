...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudRecognitionQRcodeResponse class])
    ];
...
self.requestData.serverURL = __serverURL.absoluteString;
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"QRcode" withKey:@"ci-process"];
    
    [self.requestData setQueryStringParamter:@(self.cover).stringValue withKey:@"cover"];
    return YES;
}
