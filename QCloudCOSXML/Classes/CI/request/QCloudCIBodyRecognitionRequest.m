//
//  QCloudCIBodyRecognitionRequest.m
...
@implementation QCloudCIBodyRecognitionRequest
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudBodyRecognitionResult class])
    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setQueryStringParamter:@"AIBodyRecognition" withKey:@"ci-process"];
    if(self.detectUrl){
