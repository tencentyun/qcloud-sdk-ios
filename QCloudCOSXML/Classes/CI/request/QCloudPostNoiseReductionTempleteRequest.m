//
//  QCloudPostNoiseReductionTempleteRequest.m
...
@implementation QCloudPostNoiseReductionTempleteRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudPostNoiseReductionTempleteResponse class])
    ];
