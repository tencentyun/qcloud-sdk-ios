//
//  QCloudGetWorkflowDetailRequest.m
//  QCloudGetWorkflowDetailRequest
//
//  Created by tencent
...
@implementation QCloudGetWorkflowDetailRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudWorkflowexecutionResult class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [__pathComponents addObject:@"workflowexecution"];
    if(self.runId){
        [__pathComponents addObject:self.runId];
    }
    self.requestData.URIComponents = __pathComponents;
    return YES;
}

- (void)setFinishBlock:(void (^_Nullable)(QCloudWorkflowexecutionResult *_Nullable result, NSError *_Nullable error))finishBlock {
