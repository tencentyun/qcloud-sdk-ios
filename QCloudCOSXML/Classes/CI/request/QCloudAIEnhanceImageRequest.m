...
@implementation QCloudAIEnhanceImageRequest
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"AIEnhanceImage" withKey:@"ci-process"];
    
    [self.requestData setQueryStringParamter:@(self.denoise).stringValue withKey:@"denoise"];
    [self.requestData setQueryStringParamter:@(self.sharpen).stringValue withKey:@"sharpen"];
    if (self.detectUrl) {
