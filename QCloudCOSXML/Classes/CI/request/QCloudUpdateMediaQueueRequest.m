//
//  QCloudUpdateMediaQueueRequest.m
...
@implementation QCloudUpdateMediaQueueRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    if(self.ResultFormat){
        [notifyConfig setObject:self.ResultFormat forKey:@"ResultFormat"];
    }
    
    if(self.MqMode){
        [notifyConfig setObject:self.MqMode forKey:@"MqMode"];
    }
    
    if(self.MqName){
        [notifyConfig setObject:self.MqName forKey:@"MqName"];
    }
    
    if(self.MqRegion){
        [notifyConfig setObject:self.MqRegion forKey:@"MqRegion"];
    }
