//
//  QCloudAIImageColoringRequest.m
...
@implementation QCloudAIImageColoringRequest
...
self.requestData.serverURL = __serverURL.absoluteString;
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"AIImageColoring" withKey:@"ci-process"];
    if (self.detectUrl) {
