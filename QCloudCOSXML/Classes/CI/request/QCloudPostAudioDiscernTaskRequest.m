...
@implementation QCloudPostAudioDiscernTaskRequest
- (void)dealloc {
}
- (instancetype)init {
    self = [super init];
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudPostAudioDiscernTaskResult class])
    ];
            ...
            *error = [NSError
                qcloud_errorWithCode:QCloudNetworkErrorCodeParamterInvalid
                             message:[NSString stringWithFormat:
                                                   @"InvalidArgument:paramter[taskInfo] is invalid (nil), it must have some value. please check it"]];
            return NO;
        }
    }
