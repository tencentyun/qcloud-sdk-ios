...
@implementation QCloudAIImageCropRequest
...
self.requestData.serverURL = __serverURL.absoluteString;
    ...
    [self.requestData setQueryStringParamter:self.ciProcess?:@"AIImageCrop" withKey:@"ci-process"];
    
    if (self.detectUrl) {
        [self.requestData setQueryStringParamter:self.detectUrl withKey:@"detect-url"];
    }
    [self.requestData setQueryStringParamter:@(self.width).stringValue withKey:@"width"];
    [self.requestData setQueryStringParamter:@(self.height).stringValue withKey:@"height"];
    [self.requestData setQueryStringParamter:@(self.fixed).stringValue withKey:@"fixed"];
    [self.requestData setQueryStringParamter:@(self.ignoreError).stringValue withKey:@"ignore-error"];
    return YES;
}
