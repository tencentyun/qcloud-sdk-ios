//
//  QCloudUpdateVoiceSeparateTempleteRequest.m
...
@implementation QCloudUpdateVoiceSeparateTempleteRequest
...
- (void)configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer responseSerializer:(QCloudResponseSerializer *)responseSerializer {
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudUpdateVoiceSeparateTempleteResponse class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [__pathComponents addObject:@"template"];
    if(self.TemplateId){
        [__pathComponents addObject:self.TemplateId];
    }
