...
@implementation QCloudVideoSnapshotRequest
...
,        QCloudURLFuseContentMD5Base64StyleHeaders
    ...
    NSArray *responseSerializers = @[
        ...
        QCloudResponseObjectSerilizerBlock([QCloudVideoSnapshot class])
    ];
...
- (BOOL)buildRequestData:(NSError *__autoreleasing *)error {
    ...
    [params setObject:@"Snapshot" forKey:@"Tag"];
