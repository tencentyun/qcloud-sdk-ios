//
//  QCloudAssessQualityResponse.h
//  QCloudAssessQualityResponse
//
//  Created by tencent
...
@interface QCloudAssessQualityResponse : NSObject 

/// 取值为 TRUE 或 FALSE，TRUE 为长图，FALSE 为正常图，长图定义为长宽比大于等于3或小于等于1/3的图片。
@property (nonatomic,assign) BOOL LongImage;
...
@property (nonatomic,assign) BOOL PureImage;

/// 综合评分。图像清晰度的得分，对图片的噪声、曝光、模糊、压缩等因素进行综合评估，取值为[0, 100]，值越大，越清晰。一般大于50为较清晰图片，标准可以自行把握。
@property (nonatomic,assign) NSInteger ClarityScore;

/// 综合评分。图像美观度得分，从构图、色彩等多个艺术性维度评价图片，取值为[0, 100]，值越大，越美观。一般大于50为较美观图片，标准可以自行把握。
@property (nonatomic,assign) NSInteger AestheticScore;

/// 唯一请求 ID，每次请求都会返回。定位问题时需要提供该次请求的 RequestId。
@property (nonatomic,strong) NSString * RequestId;

@property (nonatomic,assign) NSInteger LowQualityScore;
