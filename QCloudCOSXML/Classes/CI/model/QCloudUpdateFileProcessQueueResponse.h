//
//  QCloudUpdateFileProcessQueueResponse.h
...
@interface QCloudUpdateFileProcessQueueResponse : NSObject 

/// 请求的唯一 ID
@property (nonatomic,strong) NSString * RequestId;

/// 队列信息
@property (nonatomic,strong) QCloudQueueList * Queue;

@end

@interface QCloudUpdateFileProcessQueue : NSObject 
