...
#define QCloudCOSXMLModuleVersionNumber 503001

//dependency
#if QCloudCoreModuleVersionNumber != 503001
    #error "库QCloudCOSXML依赖QCloudCore最小版本号为5.3.1，当前引入的QCloudCore版本号过低，请及时升级后使用"
#endif
