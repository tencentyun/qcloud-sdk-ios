...
#define QCloudCOSXMLModuleVersionNumber 503000

//dependency
#if QCloudCoreModuleVersionNumber != 503000
    #error "库QCloudCOSXML依赖QCloudCore最小版本号为5.3.0，当前引入的QCloudCore版本号过低，请及时升级后使用"
#endif
