...
NSArray *filterUploadEventClass() {
    NSArray *arr = @[
        @"QCloudHeadObjectRequest", @"QCloudPutObjectRequest", @"QCloudUploadPartRequest", @"QCloudGetObjectRequest", @"QCloudPutObjectCopyRequest",
...
+ (void)internalUploadEvent:(NSString *)eventKey withParamter:(NSDictionary *)paramter {
    ...
    if (cls) {
        ...
        [self invokeClassMethod:cls
                            sel:NSSelectorFromString(@"trackCustomKeyValueEvent:props:appkey:isRealTime:")
