...
- (NSDictionary *)modelCustomWillTransformFromDictionary:(NSDictionary *)dic
{
    ...
    NSMutableDictionary* transfromDic = [NSMutableDictionary dictionaryWithDictionary:dic];
        ...
        if (GenerateSnapshotRotateTypeenumValue && [GenerateSnapshotRotateTypeenumValue isKindOfClass:[NSString class]] && GenerateSnapshotRotateTypeenumValue.length > 0) {
        ...
        if (GenerateSnapshotFormatenumValue && [GenerateSnapshotFormatenumValue isKindOfClass:[NSString class]] && GenerateSnapshotFormatenumValue.length > 0) {
