...
- (NSArray *)availableRegions {
    return @[
        @"ap-beijing", @"ap-shanghai", @"ap-guangzhou", @"ap-chengdu", @"ap-chongqing", @"ap-singapore", @"ap-hongkong", @"eu-frankfurt",
        @"ap-mumbai", @"ap-seoul", @"na-siliconvalley", @"na-ashburn"
    ];
}
...
- (NSString *)currentRegion {
    if (!_currentRegion) {
        _currentRegion = [SecretStorage sharedInstance].region;
    }
