...
- (void)viewWillLayoutSubviews {
    ...
    _labTipErrorInfo.frame
        = CGRectMake(marginH, _tfBucketName.frame.origin.y + _tfBucketName.frame.size.height + marginV, SCREEN_WIDTH - 2 * marginH, 20);

    _btnSelectRegion.frame
        = CGRectMake(marginH, _labTipErrorInfo.frame.origin.y + _labTipErrorInfo.frame.size.height + marginV, SCREEN_WIDTH - 2 * marginH, 44);

    _btnSubmit.frame
        = CGRectMake(marginH, _btnSelectRegion.frame.origin.y + _btnSelectRegion.frame.size.height + marginV, SCREEN_WIDTH - 2 * marginH, 35);
}
