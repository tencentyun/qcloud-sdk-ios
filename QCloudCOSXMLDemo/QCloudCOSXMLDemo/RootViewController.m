...
@interface RootViewController (){
    QCloudPNTcpPing * _tcpPing;
    QCloudPNUdpTraceroute * _udpTraceroute;
}
...
//     }];
//    
//    _tcpPing = [PNTcpPing start:@"www.baidu.com" port:443 count:3 complete:^(NSMutableString *pingres) {
//        NSLog(@"%@",pingres);
//    }];
...
//    _udpTraceroute = [PNUdpTraceroute start:@"110.242.68.3" complete:^(NSMutableString *res) {
//        NSLog(@"%@",res);
//     }];
