...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    _labFileCreateTime = [[UILabel alloc]
        initWithFrame:CGRectMake(margin, _labFileName.frame.origin.y + _labFileName.frame.size.height, SCREEN_WIDTH - margin * 3 - 120, 30)];
    ...
    _labFileSize = [[UILabel alloc] initWithFrame:CGRectMake(_labFileCreateTime.frame.size.width + _labFileCreateTime.frame.origin.x + margin * 2,
                                                             _labFileName.frame.origin.y + _labFileName.frame.size.height, 120, 30)];
