...
//    endpoint1.regionName = @"ap-beijing";
...
//                                                                                                 cosxmlServiceForKey:kSTSPolicyServiceKey] withPrefix:@"sts"];     XCTestExpectation* uploadExpectation = [self expectationWithDescription:@"uploadtemp object"];     QCloudCOSXMLUploadObjectRequest* uploadObjectRequest = [[QCloudCOSXMLUploadObjectRequest alloc] init];
