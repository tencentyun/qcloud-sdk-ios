...
#define TEST_OBJECT_PREFIX @"objectcanbedelete"
#define TEST_BUCKET_PREFIX @"btcbd"
...
- (NSString *)createTestBucketWithCosSerVice:(QCloudCOSXMLService *)service withPrefix:(NSString *)prefix {
    ...
    [bucketName appendString:TEST_BUCKET_PREFIX];
...
- (NSString *)createCanbeDeleteTestObject {
    ...
    [object appendString:TEST_OBJECT_PREFIX];
...
- (void)deleteAllTestObjects {
    [self deleteAllObjectsWithPrefix:TEST_OBJECT_PREFIX];
}
...
//    [self deleteAllBucketsWithPrefix:@"demobtcbd"];
//    [self deleteAllBucketsWithPrefix:@"domaincopy"];
//    [self deleteAllBucketsWithPrefix:@"dtbtcbd"];
    [self deleteAllBucketsWithPrefix:@"qta-"];
    [self deleteAllBucketsWithPrefix:@"sdkcertificate"];
    [self deleteAllBucketsWithPrefix:@"tfbtcbd"];
    [self deleteAllBucketsWithPrefix:@"waytestkstongji"];
    [self deleteAllBucketsWithPrefix:@"bucketbtcbd"];
