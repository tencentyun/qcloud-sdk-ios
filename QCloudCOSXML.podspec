...
s.version              = "6.4.2"
  ...
  default.dependency "QCloudCore",'6.4.2'
  end
  s.subspec 'Slim' do |slim|
    slim.source_files = 'QCloudCOSXML/Classes/**/*','QCloudCOSXML/Classes/QCloudCOSXML/*'
  slim.dependency "QCloudCore/WithoutMTA",'6.4.2'
  end
  s.subspec 'Transfer' do |transfer|
    transfer.source_files = 'QCloudCOSXML/Classes/*','QCloudCOSXML/Classes/Transfer/**/*','QCloudCOSXML/Classes/Base/**/*'
  transfer.dependency "QCloudCore/WithoutMTA",'6.4.2'
  ...
  widget.dependency "QCloudCore/WithoutMTA",'6.4.2'
  end
