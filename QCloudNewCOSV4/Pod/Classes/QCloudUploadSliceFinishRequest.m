...
@implementation QCloudUploadSliceFinishRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray* responseSerializers = @[
                                    ...
                                    QCloudResponseObjectSerilizerBlock([QCloudUploadSliceFinishResult class])
                                    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setParameter:@"upload_slice_finish" withKey:@"op"];
...
- (void) setFinishBlock:(void (^)(QCloudUploadSliceFinishResult* result, NSError * error))QCloudRequestFinishBlock
{
