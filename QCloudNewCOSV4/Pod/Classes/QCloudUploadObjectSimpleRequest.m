...
@implementation QCloudUploadObjectSimpleRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    if (self.filePath) {
        if(![self.requestData appendPartWithFileURL:[NSURL fileURLWithPath:self.filePath] name:@"filecontent" fileName:[NSUUID UUID].UUIDString mimeType:@"filecontent" headerParamters:@{} error:error])
        {
          return NO;
        }
    }
    ...
    [self.requestData setParameter:@"upload" withKey:@"op"];
