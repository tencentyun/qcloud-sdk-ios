...
@implementation QCloudDirectoryAttributesRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray* responseSerializers = @[
                                    ...
                                    QCloudResponseObjectSerilizerBlock([QCloudDirectoryAttributesResult class])
                                    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setParameter:@"stat" withKey:@"op"];
...
- (void) setFinishBlock:(void (^)(QCloudDirectoryAttributesResult* result, NSError * error))QCloudRequestFinishBlock
{
