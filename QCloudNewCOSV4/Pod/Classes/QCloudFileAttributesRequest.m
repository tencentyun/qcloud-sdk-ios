...
@implementation QCloudFileAttributesRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray* responseSerializers = @[
                                    ...
                                    QCloudResponseObjectSerilizerBlock([QCloudFileInfo class])
                                    ];
...
- (void) setFinishBlock:(void (^)(QCloudFileInfo* result, NSError * error))QCloudRequestFinishBlock
{
