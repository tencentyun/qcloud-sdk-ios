...
@implementation QCloudListDirectoryRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray* responseSerializers = @[
                                    ...
                                    QCloudResponseObjectSerilizerBlock([QCloudListDirectoryResult class])
                                    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setParameter:self.context withKey:@"context"];
    [self.requestData setNumberParamter:@(self.number) withKey:@"num"];
    ...
    [self.requestData setParameter:@"list" withKey:@"op"];
...
- (void) setFinishBlock:(void (^)(QCloudListDirectoryResult* result, NSError * error))QCloudRequestFinishBlock
{
