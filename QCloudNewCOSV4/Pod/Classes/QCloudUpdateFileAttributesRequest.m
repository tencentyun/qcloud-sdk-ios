...
@implementation QCloudUpdateFileAttributesRequest
- (void) dealloc
{
    [self removeObserver:self forKeyPath:@"attributes"];
    [self removeObserver:self forKeyPath:@"authority"];
    [self removeObserver:self forKeyPath:@"customHeaders"];
}
-  (instancetype) init
{
    self = [super init];
    ...
    [self addObserver:self forKeyPath:@"attributes" options:NSKeyValueObservingOptionNew|NSKeyValueObservingOptionOld context:NULL];
    [self addObserver:self forKeyPath:@"authority" options:NSKeyValueObservingOptionNew|NSKeyValueObservingOptionOld context:NULL];
    [self addObserver:self forKeyPath:@"customHeaders" options:NSKeyValueObservingOptionNew|NSKeyValueObservingOptionOld context:NULL];
    return self;
}
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setParameter:self.attributes withKey:@"biz_attr"];
    [self.requestData setParameter:self.authority withKey:@"authority"];
    [self.requestData setNumberParamter:@(self.flag) withKey:@"flag"];
    [self.requestData setParameter:[self.customHeaders qcloud_modelToJSONObject] withKey:@"custom_headers"];
    ...
    [self.requestData setParameter:@"update" withKey:@"op"];
