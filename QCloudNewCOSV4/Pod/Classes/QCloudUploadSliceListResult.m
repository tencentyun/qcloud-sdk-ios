...
@class QCloudUploadSliceInfo;

NS_ASSUME_NONNULL_BEGIN
@implementation QCloudUploadSliceListResult

+ (NSDictionary *)modelContainerPropertyGenericClass
{
   return @ {
      @"existSlices":[QCloudUploadSliceInfo class],
  };
}
...
+ (NSDictionary *)modelCustomPropertyMapper
{
  return @{
      ...
      @"fileSize" :@"filesize",
      @"sliceSize" :@"flice_size",
      @"existSlices" :@"listparts",
  };
}
