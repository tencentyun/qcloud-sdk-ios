...
@implementation QCloudListUploadSliceRequest
- (void) dealloc
{
}
-  (instancetype) init
...
- (void) configureReuqestSerializer:(QCloudRequestSerializer *)requestSerializer  responseSerializer:(QCloudResponseSerializer *)responseSerializer
{
    ...
    NSArray* responseSerializers = @[
                                    ...
                                    QCloudResponseObjectSerilizerBlock([QCloudListUploadSliceResult class])
                                    ];
...
- (BOOL) buildRequestData:(NSError *__autoreleasing *)error
{
    ...
    [self.requestData setParameter:@"upload_slice_list" withKey:@"op"];
...
- (void) setFinishBlock:(void (^)(QCloudListUploadSliceResult* result, NSError * error))QCloudRequestFinishBlock
{
